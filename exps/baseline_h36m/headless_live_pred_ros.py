...
class LiveSkeletonPublisher:
    def __init__(self, topic_name='/human_skeleton/live_prediction'):
        try:
            ...
            print("✅ Initialized siMLPe ROS Publisher Node (Headless Mode).")
...
def main(opt):
    print("Running Body Tracking (Headless Mode) ... Press Ctrl+C to quit.")
    ...
    try:
        while not rospy.is_shutdown():
            if zed.grab() == sl.ERROR_CODE.SUCCESS:
                # Retrieve ONLY bodies (skip heavy 1080p image retrieval)
